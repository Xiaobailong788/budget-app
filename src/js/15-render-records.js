...
let recordsPerPage = parseInt(localStorage.getItem('budgetRecordsPerPage') || '20');
let batchMode = false;
    ...
    <div class="card mb-16">
      ...
      <div class="flex gap-8 mt-8" style="flex-wrap:wrap">
        ...
        <span class="text-xs text-muted" style="display:inline-flex;align-items:center;gap:4px">
          每页 <input type="number" id="recordsPageSizeInput" value="${recordsPerPage}" min="5" max="200" 
          onchange="
...
function renderRecordsList() {
  ...
  if (recordsPage >= totalPages) recordsPage = Math.max(0, totalPages - 1);
